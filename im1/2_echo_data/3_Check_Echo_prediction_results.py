...
# * 1. Retrieve prediction results from yolov5/runs/val and save them in Result_echo_detect/images and Result_echo_detect/preds.
# * 2. Compare with the original images to find regions that were not detected.
# * 3. Crop the detected bounding boxes and save them in the Result_echo_detect/crop_results folder.

# ### Save labels from runs/val/test_fold_{i} to "./Result_echo_detect/preds" folder
...
dest_dir = "./Result_echo_detect/preds"
...
# ### Save all images from "./Result_echo_detect/Result_crop_images" to "./Result_echo_detect/images"
...
dest_dir = "./Result_echo_detect/images"
...
images_filenames = {os.path.splitext(f)[0] for f in os.listdir("../2_echo_data/Result_echo_detect/images") if f.endswith(".jpg")}
preds_filenames = {os.path.splitext(f)[0] for f in os.listdir("../2_echo_data/Result_echo_detect/preds") if f.endswith(".txt")}
