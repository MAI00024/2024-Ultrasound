...
# Move "split_for_echo_detection" folder to "yolov5" folder
def move_split_folder():
    src_path = './split_for_echo_detection'
    dst_path = './yolov5/split_for_echo_detection'
...
def main():
    ...
    wandb_api_key = "e82da6563d93654dbd624681e5321e560269f670"    
    login_wandb(wandb_api_key)

    # Path configuration
    data_path = './split_for_echo_detection'
